...
class SchedulerServiceTest {
    ...
    void generateCalendar() {
        ...
        StepVerifier.create(response)
                .expectNextMatches(programDate -> programDate.getDate().toString().equals("2022-01-03")
                        && programDate.getCategoryName().equals("Principios"))
                .expectNextMatches(programDate -> programDate.getDate().toString().equals("2022-01-04")
                        && programDate.getCategoryName().equals("Principios"))
                .expectNextMatches(programDate -> programDate.getDate().toString().equals("2022-01-05")
                        && programDate.getCategoryName().equals("Bases"))
                .expectNextMatches(programDate -> programDate.getDate().toString().equals("2022-01-06")
                        && programDate.getCategoryName().equals("Bases"))
                .expectNextMatches(programDate -> programDate.getDate().toString().equals("2022-01-07")
                        && programDate.getCategoryName().equals("Fundamentos"))
                .expectNextMatches(programDate -> programDate.getDate().toString().equals("2022-01-10")
                        && programDate.getCategoryName().equals("Fundamentos"))
                .expectNextMatches(programDate -> programDate.getDate().toString().equals("2022-01-11")
                        && programDate.getCategoryName().equals("Fundamentos"))
                .expectNextMatches(programDate -> programDate.getDate().toString().equals("2022-01-12")
                        && programDate.getCategoryName().equals("Fundamentos"))
                .expectNextMatches(programDate -> programDate.getDate().toString().equals("2022-01-13")
                        && programDate.getCategoryName().equals("Fundamentos avazandos"))
                .expectNextMatches(programDate -> programDate.getDate().toString().equals("2022-01-14")
                        && programDate.getCategoryName().equals("Fundamentos avazandos"))
                .expectNextMatches(programDate -> programDate.getDate().toString().equals("2022-01-17")
                        && programDate.getCategoryName().equals("Fundamentos avazandos"))
                .expectNextMatches(programDate -> programDate.getDate().toString().equals("2022-01-18")
                        && programDate.getCategoryName().equals("Fundamentos avazandos"))
                .expectNextMatches(programDate -> programDate.getDate().toString().equals("2022-01-19")
                        && programDate.getCategoryName().equals("Fundamentos avazandos"))
                .verifyComplete();
    ...
    void programNoFound() {
        ...
        StepVerifier.create(response).verifyErrorMatches(error -> error.getClass() == RuntimeException.class);
